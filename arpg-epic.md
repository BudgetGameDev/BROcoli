...
- Otherwise run every maintained baseline and story scenario through `./scripts/autoplay-run.sh`, the full relevant suite, and final Unity validation. Verify all evidence and statuses and confirm a clean worktree.
