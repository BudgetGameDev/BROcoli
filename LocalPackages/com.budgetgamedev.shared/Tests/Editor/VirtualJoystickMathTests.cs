    ...
    public sealed class VirtualJoystickMathTests
    {
        ...
        public void StickTravelProducesGradualAnalogMagnitudes()
        {
            float nearCenter = VirtualJoystickMath
                ...
                .x;
            float quarter = VirtualJoystickMath
                .AnalogInput(Vector2.right * 25f, 100f, 0.06f, 1.25f)
                .x;
            float half = VirtualJoystickMath.AnalogInput(Vector2.right * 50f, 100f, 0.06f, 1.25f).x;
            float full = VirtualJoystickMath
                .AnalogInput(Vector2.right * 100f, 100f, 0.06f, 1.25f)
                .x;
        ...
        {
            Vector2 inside = VirtualJoystickMath.AnalogInput(
                Vector2.right * 5f,
                100f,
                0.06f,
                1.25f
            );
            Vector2 outside = VirtualJoystickMath.AnalogInput(
                Vector2.right * 7f,
                100f,
                0.06f,
                1.25f
        ...
        {
            Vector2 input = VirtualJoystickMath.AnalogInput(
                new Vector2(30f, 40f),
                100f,
                0.06f,
                1.25f
