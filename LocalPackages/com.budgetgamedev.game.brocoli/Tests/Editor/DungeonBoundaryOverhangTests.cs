...
namespace BudgetGameDev.Games.Brocoli.Tests
{
    ...
    public sealed class DungeonBoundaryOverhangTests
    {
        ...
        private static readonly float TrimmedDepth =
            DungeonWallPiece.MeshDepthAlongNormal + DungeonWallPiece.MeshBodyDepthAgainstNormal;
        ...
        public void TheSouthCliffHangsNothingLooseOverTheVoid()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(TrimmedDepth).Within(Tolerance),
                "a south cliff piece still draws its loose base rocks"
            );
        }
        ...
        public void TheSideCliffHangsNothingLooseOverTheVoid()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(TrimmedDepth).Within(Tolerance),
                "a side cliff piece still draws its loose base rocks"
            );
        }
