    ...
    public sealed partial class OcclusionCoverageTests
    {
        ...
        private sealed class BoxWorld : IOcclusionCandidateSource
        {
            ...
            public void Collect(Ray ray, float maximumDistance, List<OcclusionCandidate> results)
            {
                ...
                {
                    if (
                        box.Bounds.IntersectRay(ray, out float distance)
        ...
        public void CoverageOnlyGrowsAsAnObstacleGetsTaller()
        {
            ...
            Assert.That(
                previous,
                Is.GreaterThan(0.9f),
                "even a 3.00-tall wall never hid the player"
            );
        }
        ...
        public void CoverageOnlyGrowsAsAnObstacleGetsWider()
        {
            ...
            Assert.That(
                previous,
                Is.GreaterThan(0.9f),
                "even a 3.00-wide wall never hid the player"
            );
        }
        ...
        public void ATallerCharacterIsHarderToHideBehindTheSameObstacle()
        {
            ...
            float tallCharacter = CoverageOfObstacle(
                width: 3f,
                height: 1.4f,
                characterHeight: 2.6f
            );
