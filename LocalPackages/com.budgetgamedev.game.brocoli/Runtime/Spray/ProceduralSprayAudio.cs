...
namespace BudgetGameDev.Games.Brocoli
{
    ...
    public class ProceduralSprayAudio : MonoBehaviour
    {
        ...
        [Range(0f, 1f)]
        [SerializeField]
        private float volume = 0.18f;

        [Header("Spray Characteristics")]
        [Range(0.1f, 2f)]
        [SerializeField]
        private float sprayDuration = 0.4f;

        [Range(0f, 0.15f)]
        [SerializeField]
        private float randomization = 0.05f;

        [Header("Sound Settings")]
        [Range(3000f, 10000f)]
        [SerializeField]
        private float hissFrequency = 6000f;

        [Range(0.5f, 2f)]
        [SerializeField]
        private float pressureIntensity = 0.8f;

        [Range(0.1f, 1f)]
        [SerializeField]
        private float airiness = 0.6f;
