...
namespace BudgetGameDev.Games.Brocoli
{
    ...
    public class SprayAudioClipGenerator
    {
        ...
        public SprayAudioClipGenerator(
            int sampleRate,
            float hissFrequency,
        ...
        public AudioClip GenerateSprayBurst(float duration)
        {
            ...
            for (int i = 0; i < totalSamples; i++)
            {
                ...
                float highShimmer =
                    filters.ApplyHighpass(pinkNoise, baseHiss * 1.8f) * 0.08f * airiness;
        ...
        public AudioClip GenerateSprayLoop(float duration)
        {
            ...
            for (int i = 0; i < totalSamples; i++)
            {
                ...
                float highShimmer =
                    filters.ApplyHighpass(pinkNoise, hissFrequency * 1.6f) * 0.06f * airiness;
        ...
        public AudioClip GenerateSprayEnd(float duration)
        {
            ...
            for (int i = 0; i < totalSamples; i++)
            {
                ...
                {
                    float sputter =
                        Mathf.Sin(t * 40f * Mathf.PI * 2f) * (normalizedT - 0.5f) * 0.3f;
                    sample *= (1f + sputter);
                }
