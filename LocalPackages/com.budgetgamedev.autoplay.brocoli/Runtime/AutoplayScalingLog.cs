...
namespace BudgetGameDev.Games.Brocoli
{
    ...
    internal readonly struct ScalingSample
    {
        ...
        /// <summary>Whether health, damage, or count has run out of power-scaling headroom.</summary>
        ...
        /// <summary>Informational movement safety ceiling, independent of power-scaling headroom.</summary>
        internal bool SpeedCapped => EnemyScaling.AtCap(SpeedScale, EnemyScaling.MaxSpeedScale);
    }
