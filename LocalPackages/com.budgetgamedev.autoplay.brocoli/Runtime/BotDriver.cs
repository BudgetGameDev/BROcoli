...
namespace BudgetGameDev.Games.Brocoli
{
    ...
    public partial class BotDriver : MonoBehaviour
    {
        ...
        private readonly HashSet<Vector2Int> rejectedExits = new();
        public static string LastPathStatus { get; private set; } = "none";
        public static Vector2 NavigationTarget { get; private set; }
        public static int FailedPathCount { get; private set; }

        private Transform player;
        private PlayerMovement movement;
        private int cachedCornerCount;
        private int cachedCornerIndex;
        private Vector2 cachedPathEndpoint;
        private bool hasCachedRoute;
        public static bool ActiveRoute { get; private set; }
        public static Vector2 AcceptedStep { get; private set; }
        public static int BlockedStepCount { get; private set; }
        public static bool MovementBlocked { get; private set; }
        public static string StepStatus { get; private set; } = "none";
        private PlayerStats stats;
        private DungeonManager dungeon;
        private readonly BotDoorwayCommitment doorwayCommitment = new();
        ...
        private float lastCombatProgress;
