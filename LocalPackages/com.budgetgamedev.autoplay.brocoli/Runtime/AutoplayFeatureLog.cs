...
namespace BudgetGameDev.Games.Brocoli
{
    ...
    {
        private static readonly FeatureLedger Counts = new();
        ...
        internal static void Record(string feature)
        {
            ...
            int seen = Counts.Record(feature);
            ...
            AutoplayCaptureTriggers.Notify(feature, seen);
        }
        ...
        internal static int Count(string feature) => Counts.Count(feature);
        ...
        {
            return Counts.Missing(required);
        }
