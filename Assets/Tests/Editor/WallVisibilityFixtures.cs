...
internal static class WallVisibilityFixtures
{
    ...
    /// </summary>
    public static bool TryFindInteriorScreen(out int seed, out Vector2Int room, out Vector2 anchor)
    {
    ...
    {
        return TryFindRoom(
            (layout, candidate) => Passage(layout, candidate, DungeonLayout.South).OpeningCount > 0,
            out seed,
            out room
        );
    }
