...
public sealed class DungeonPropOcclusionTests
{
    ...
    public void APropTheSystemHasNeverSeenIsAdoptedAsAnOccluder()
    {
        ...
        DungeonOccluder occluder = DungeonOccluder.Owning(prop.GetComponentInChildren<Collider>());
    ...
    public void EverySolidPieceARoomBuildsCanBeLoweredAndKeepsItsBase()
    {
        ...
        try
        {
            ...
            DungeonPropFixtures
                .Placer(host, prefabs)
                .BuildContents(room.transform, cell, archetype, layout.RoomRandom(cell, 505), null);
