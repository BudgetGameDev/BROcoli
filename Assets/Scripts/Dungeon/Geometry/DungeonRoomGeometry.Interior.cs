...
public static partial class DungeonRoomGeometry
{
    ...
    private static void AppendHorizontalRuns(List<DungeonWallPiece> walls, Vector2 center, float z)
    {
        AppendHorizontalRun(walls, center, z);
        AppendHorizontalRun(walls, center, -z);
    }

    private static void AppendVerticalRuns(List<DungeonWallPiece> walls, Vector2 center, float x)
    {
        AppendVerticalRun(walls, center, x);
        AppendVerticalRun(walls, center, -x);
    }

    private static void AppendHorizontalRun(List<DungeonWallPiece> walls, Vector2 center, float z)
    {
