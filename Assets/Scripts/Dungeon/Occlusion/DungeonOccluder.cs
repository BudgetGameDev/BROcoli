...
public class DungeonOccluder : MonoBehaviour
{
    ...
    public static DungeonOccluder Owning(Component candidate)
    {
        ...
        DungeonOccluder adopted =
            root.GetComponent<DungeonOccluder>() ?? root.gameObject.AddComponent<DungeonOccluder>();
        adopted.Register();
        return adopted;
    }
    ...
    public virtual bool BelongsToRoom(Vector2Int room, DungeonLayout layout)
    {
        ...
        return RoomsMatch(room, DungeonLayout.RoomAt(new Vector2(position.x, position.z)), layout);
    }
