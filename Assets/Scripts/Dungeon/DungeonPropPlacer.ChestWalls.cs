...
public partial class DungeonPropPlacer
{
    ...
    )
    {
        ...
        return archetype.Shape switch
        {
            ...
            DungeonLayout.RoomShape.NarrowVertical => OverlapsVerticalRuns(point, clearance, 4f),
            DungeonLayout.RoomShape.LargeSquare => OverlapsVerticalRuns(point, clearance, 10f),
            DungeonLayout.RoomShape.LongHorizontal => OverlapsHorizontalRuns(point, clearance, 6f),
