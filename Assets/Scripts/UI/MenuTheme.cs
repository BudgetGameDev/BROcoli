...
public static class MenuTheme
{
    ...
    public static RectTransform CreatePanel(string objectName, RectTransform parent, Color color)
    {
    ...
    public static void SetTopAnchored(RectTransform rect, float inset, float width, float height)
    {
